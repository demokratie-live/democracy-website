<div class="single">
    <div class="container">
        <div class="agileits-single-img">
            <img src="./files/landing/ceta.jpg" alt="">
            ...
            <p>Es ist zu befürchten, dass die Demokratie so zur reinen Fassade verkommt, was unser Grundgesetz ausschließt.“ — <em>Marianne Grimmenstein</em></p>
            ...
            <p>Technisch gesehen, haben wir dazu alle Möglichkeiten in der Hand.<br>Die App DEMOCRACY ist der Vorschlag, diese zu nutzen.<br>Entscheide DU.</p>

            <a href="http://startnext.com/democracy" class="call_to_action">
                Unterstütze unser Projekt auf<br>
                <img src="./files/images/startnext_logo.png" alt="startnext_logo">
            </a>
        </div>
    </div>
</div>