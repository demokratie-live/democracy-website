...
class default_wir implements SYSTEM\PAGE\Page {
    ...
    public function html(){
        ...
        $team = array(  array(  'name' => 'Marius Krüger', 'text' => 'Mädchen für alles<br>Initiator', 'img' => './files/wir/marius_krueger.jpg',
                        ...
                        array(  'name' => 'Manuel Ruck', 'text' => 'Arbeitstier<br>React-Experte', 'img' => './files/wir/userdefault.jpg', //'./files/wir/manuel_ruck.jpg',
        ...
        $vars['contributors'] = '';
        $contributors = array(  array(  'name' => 'Dr. Annika Götz', 'text' => 'Kommunikatorin<br>Öffentlichkeitsarbeit', 'img' => './files/wir/annika_goetz.jpg',
        ...
        $network =  array(  array(  'name' => '4 Teammitglieder', 'text' => '', 'img' => './files/wir/userdefault.jpg',//'./files/wir/team.jpg',
                                    'links' => array()),
                            array(  'name' => '13 Unterstützer', 'text' => '', 'img' => './files/wir/userdefault.jpg',//'./files/wir/contributors.jpg',
                                    'links' => array()),
                            array(  'name' => '168 Prototyp-Tester', 'text' => '', 'img' => './files/wir/userdefault.jpg',//'./files/wir/prototypetesters.jpg',
                                    'links' => array()),
                            array(  'name' => '349 Fans', 'text' => '', 'img' => './files/wir/userdefault.jpg',//'./files/wir/fans.jpg',
                                    'links' => array()),
                            array(  'name' => '542 Spender', 'text' => '', 'img' => './files/wir/userdefault.jpg',//'./files/wir/donators.jpg',
                                    'links' => array()));
        foreach($network as $member){
            ...
            foreach($links as $link){
                $member['links'] .= \SYSTEM\PAGE\replace::replaceFile((new PPAGE('default_wir/tpl/team_link.tpl'))->SERVERPATH(), $link);}
            $vars['network'] .= \SYSTEM\PAGE\replace::replaceFile((new PPAGE('default_wir/tpl/team_member.tpl'))->SERVERPATH(), $member);}
