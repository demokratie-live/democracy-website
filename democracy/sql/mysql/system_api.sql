...
REPLACE INTO `system_api` (`ID`, `group`, `type`, `parentID`, `parentValue`, `name`, `verify`) VALUES (124, 0, 2, 10, 'beta', 'newsletter', 'BOOL');

REPLACE INTO `system_api` (`ID`, `group`, `type`, `parentID`, `parentValue`, `name`, `verify`) VALUES (100, 1, 2, 1, 'unsubscribe', 'token', 'STRING');