...
export function AdminHeader({ user, onToggleDarkMode, isDarkMode }: AdminHeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-30 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
      <div className="flex items-center justify-between h-16 px-4 lg:px-6">
        ...
        <div className="flex items-center flex-1 lg:ml-0 ml-12">
          {/* Search */}
          <div className="relative max-w-md w-full hidden md:block">
            ...
            <input
              type="text"
              placeholder="Suchen..."
              className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:text-white"
            />
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            ...
            >
              <div className="w-8 h-8 rounded-full flex items-center justify-center text-white text-sm font-medium" style={{ backgroundColor: 'rgb(68, 148, 211)' }}>
            ...
            {userMenuOpen && (
              <>
                ...
                />
                <div className="absolute right-0 mt-2 w-56 rounded-lg bg-white dark:bg-gray-700 shadow-lg border border-gray-200 dark:border-gray-600 z-20">
