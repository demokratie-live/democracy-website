    ...
    <>
      <div className="flex items-center gap-2">
        <button
          ...
          title={faq.active ? 'Deaktivieren' : 'Aktivieren'}
        >
          {faq.active ? (
        ...
        <Link
          href={`/admin/dashboard/faqs/${faq.id}/edit`}
          className="p-1.5 rounded hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-400"
          title="Bearbeiten"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <ConfirmDialog
        ...
        title="FAQ löschen"
        message={`Möchten Sie die FAQ "${faq.question}" wirklich löschen? Diese Aktion kann nicht rückgängig gemacht werden.`}
